          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919999999999" className="text-sm font-body text-white/70 hover:text-white transition-colors">+91 99999 99999</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-[var(--accent)]" />
                <a href="mailto:info@pelicangardens.in" className="text-sm font-body text-white/70 hover:text-white transition-colors">info@pelicangardens.in</a>
              </li>
            </ul>
          </div>
        </div>
